...
/** Generated Model for DS_OrgMaster_Location
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_DS_OrgMaster_Location extends PO implements I_DS_OrgMaster_Location, I_Persistent 
{
    ...
    public X_DS_OrgMaster_Location (Properties ctx, int DS_OrgMaster_Location_ID, String trxName)
    {
      super (ctx, DS_OrgMaster_Location_ID, trxName);
      /** if (DS_OrgMaster_Location_ID == 0)
        {
			setC_Location_ID (0);
			setDS_OrgMaster_ID (0);
			setDS_OrgMaster_Location_ID (0);
			setName (null);
// .
        } */
    }
    ...
    /** Load Constructor */
    public X_DS_OrgMaster_Location (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DS_OrgMaster_Location[")
	...
	/** Set DS_OrgMaster_Location_UU.
		@param DS_OrgMaster_Location_UU DS_OrgMaster_Location_UU	  */
	public void setDS_OrgMaster_Location_UU (String DS_OrgMaster_Location_UU)
	{
		set_Value (COLUMNNAME_DS_OrgMaster_Location_UU, DS_OrgMaster_Location_UU);
	}

	/** Get DS_OrgMaster_Location_UU.
		@return DS_OrgMaster_Location_UU	  */
	public String getDS_OrgMaster_Location_UU () 
	{
		return (String)get_Value(COLUMNNAME_DS_OrgMaster_Location_UU);
	}
