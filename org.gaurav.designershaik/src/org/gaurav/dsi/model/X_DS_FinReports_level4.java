...
/** Generated Model for DS_FinReports_level4
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_DS_FinReports_level4 extends PO implements I_DS_FinReports_level4, I_Persistent 
{
    ...
    public X_DS_FinReports_level4 (Properties ctx, int DS_FinReports_level4_ID, String trxName)
    {
      super (ctx, DS_FinReports_level4_ID, trxName);
      /** if (DS_FinReports_level4_ID == 0)
        {
			setDS_FinReports_level4_ID (0);
        } */
    }

    /** Load Constructor */
    public X_DS_FinReports_level4 (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DS_FinReports_level4[")
	...
	public I_DS_FinReports_level3 getDS_FinReports_level3() throws RuntimeException
    {
		return (I_DS_FinReports_level3)MTable.get(getCtx(), I_DS_FinReports_level3.Table_Name)
			.getPO(getDS_FinReports_level3_ID(), get_TrxName());	}
	...
	/** Set DS_FinReports_level4_UU.
		@param DS_FinReports_level4_UU DS_FinReports_level4_UU	  */
	public void setDS_FinReports_level4_UU (String DS_FinReports_level4_UU)
	{
		set_Value (COLUMNNAME_DS_FinReports_level4_UU, DS_FinReports_level4_UU);
	}

	/** Get DS_FinReports_level4_UU.
		@return DS_FinReports_level4_UU	  */
	public String getDS_FinReports_level4_UU () 
	{
		return (String)get_Value(COLUMNNAME_DS_FinReports_level4_UU);
	}
