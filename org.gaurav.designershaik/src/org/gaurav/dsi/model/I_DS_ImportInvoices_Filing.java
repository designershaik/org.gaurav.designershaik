...
/** Generated Interface for DS_ImportInvoices_Filing
 *  @author iDempiere (generated) 
 *  @version Release 5.1
 */
@SuppressWarnings("all")
public interface I_DS_ImportInvoices_Filing 
{

    /** TableName=DS_ImportInvoices_Filing */
    public static final String Table_Name = "DS_ImportInvoices_Filing";
    ...
    /** Column name DS_CalculatedTaxAmt */
    public static final String COLUMNNAME_DS_CalculatedTaxAmt = "DS_CalculatedTaxAmt";
    ...
    /** Column name DS_ImportInvoices_Filing_ID */
    public static final String COLUMNNAME_DS_ImportInvoices_Filing_ID = "DS_ImportInvoices_Filing_ID";
    ...
    /** Column name DS_ImportInvoices_Filing_UU */
    public static final String COLUMNNAME_DS_ImportInvoices_Filing_UU = "DS_ImportInvoices_Filing_UU";
    ...
    /** Column name DS_Invoice_TaxDetails_ID */
    public static final String COLUMNNAME_DS_Invoice_TaxDetails_ID = "DS_Invoice_TaxDetails_ID";
    ...
    /** Column name DS_TaxFiling_ID */
    public static final String COLUMNNAME_DS_TaxFiling_ID = "DS_TaxFiling_ID";
    ...
    /** Column name linenetamtbase */
    public static final String COLUMNNAME_linenetamtbase = "linenetamtbase";
    ...
    /** Column name linetotalamtbase */
    public static final String COLUMNNAME_linetotalamtbase = "linetotalamtbase";
