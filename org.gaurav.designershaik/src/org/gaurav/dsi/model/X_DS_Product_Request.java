...
/** Generated Model for DS_Product_Request
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_DS_Product_Request extends PO implements I_DS_Product_Request, I_Persistent 
{
    ...
    public X_DS_Product_Request (Properties ctx, int DS_Product_Request_ID, String trxName)
    {
      super (ctx, DS_Product_Request_ID, trxName);
      /** if (DS_Product_Request_ID == 0)
        {
			setDS_Product_Request_ID (0);
        } */
    }

    /** Load Constructor */
    public X_DS_Product_Request (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DS_Product_Request[")
	...
	{
		set_Value (COLUMNNAME_DS_ActualAmt, DS_ActualAmt);
	}

	/** Get Actual Amt Spent.
		@return Actual Amt Spent
	  */
	public BigDecimal getDS_ActualAmt () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DS_ActualAmt);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Products on request.
		@param DS_Product_Request_ID Products on request	  */
	public void setDS_Product_Request_ID (int DS_Product_Request_ID)
	{
		if (DS_Product_Request_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DS_Product_Request_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DS_Product_Request_ID, Integer.valueOf(DS_Product_Request_ID));
	}

	/** Get Products on request.
		@return Products on request	  */
	public int getDS_Product_Request_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DS_Product_Request_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set DS_Product_Request_UU.
		@param DS_Product_Request_UU DS_Product_Request_UU	  */
	public void setDS_Product_Request_UU (String DS_Product_Request_UU)
	{
		set_Value (COLUMNNAME_DS_Product_Request_UU, DS_Product_Request_UU);
	}

	/** Get DS_Product_Request_UU.
		@return DS_Product_Request_UU	  */
	public String getDS_Product_Request_UU () 
	{
		return (String)get_Value(COLUMNNAME_DS_Product_Request_UU);
	}
    ...
    {
        return new KeyNamePair(get_ID(), getProductDescription());
    }
