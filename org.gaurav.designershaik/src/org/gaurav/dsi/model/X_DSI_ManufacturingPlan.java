...
/** Generated Model for DSI_ManufacturingPlan
 *  @author iDempiere (generated) 
 *  @version Release 7.1 - $Id$ */
public class X_DSI_ManufacturingPlan extends PO implements I_DSI_ManufacturingPlan, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20211202L;

    /** Standard Constructor */
    public X_DSI_ManufacturingPlan (Properties ctx, int DSI_ManufacturingPlan_ID, String trxName)
    {
      super (ctx, DSI_ManufacturingPlan_ID, trxName);
      /** if (DSI_ManufacturingPlan_ID == 0)
        {
			setDSI_ManufacturingPlan_ID (0);
			setDSI_ManufacturingPlan_UU (null);
        } */
    }

    /** Load Constructor */
    public X_DSI_ManufacturingPlan (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DSI_ManufacturingPlan[")
	...
	/** Set Manufacturing Plan.
		@param DSI_ManufacturingPlan_ID Manufacturing Plan	  */
	public void setDSI_ManufacturingPlan_ID (int DSI_ManufacturingPlan_ID)
	{
		if (DSI_ManufacturingPlan_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DSI_ManufacturingPlan_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DSI_ManufacturingPlan_ID, Integer.valueOf(DSI_ManufacturingPlan_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DSI_ManufacturingPlan_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set DSI_ManufacturingPlan_UU.
		@param DSI_ManufacturingPlan_UU DSI_ManufacturingPlan_UU	  */
	public void setDSI_ManufacturingPlan_UU (String DSI_ManufacturingPlan_UU)
	{
		set_ValueNoCheck (COLUMNNAME_DSI_ManufacturingPlan_UU, DSI_ManufacturingPlan_UU);
	}

	/** Get DSI_ManufacturingPlan_UU.
		@return DSI_ManufacturingPlan_UU	  */
	public String getDSI_ManufacturingPlan_UU () 
	{
		return (String)get_Value(COLUMNNAME_DSI_ManufacturingPlan_UU);
	}
    ...
    {
		return (I_DSI_SalesForecast)MTable.get(getCtx(), I_DSI_SalesForecast.Table_Name)
			.getPO(getDSI_SalesForecast_ID(), get_TrxName());	}
	...
	/** Set QtyReserve.
		@param QtyReserve QtyReserve	  */
	public void setQtyReserve (BigDecimal QtyReserve)
	{
		set_ValueNoCheck (COLUMNNAME_QtyReserve, QtyReserve);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyReserve);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_onorderqty, onorderqty);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_onorderqty);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
