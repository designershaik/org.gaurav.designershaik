...
/** Generated Model for DS_FinReports_level1
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_DS_FinReports_level1 extends PO implements I_DS_FinReports_level1, I_Persistent 
{
    ...
    public X_DS_FinReports_level1 (Properties ctx, int DS_FinReports_level1_ID, String trxName)
    {
      super (ctx, DS_FinReports_level1_ID, trxName);
      /** if (DS_FinReports_level1_ID == 0)
        {
			setDS_FinReports_level1_ID (0);
        } */
    }

    /** Load Constructor */
    public X_DS_FinReports_level1 (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DS_FinReports_level1[")
    ...
    {
		return (I_DS_FinReports)MTable.get(getCtx(), I_DS_FinReports.Table_Name)
			.getPO(getDS_FinReports_ID(), get_TrxName());	}
	...
	/** Set DS_FinReports_level1_UU.
		@param DS_FinReports_level1_UU DS_FinReports_level1_UU	  */
	public void setDS_FinReports_level1_UU (String DS_FinReports_level1_UU)
	{
		set_Value (COLUMNNAME_DS_FinReports_level1_UU, DS_FinReports_level1_UU);
	}

	/** Get DS_FinReports_level1_UU.
		@return DS_FinReports_level1_UU	  */
	public String getDS_FinReports_level1_UU () 
	{
		return (String)get_Value(COLUMNNAME_DS_FinReports_level1_UU);
	}
