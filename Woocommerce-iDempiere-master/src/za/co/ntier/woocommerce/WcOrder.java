...
public final class WcOrder {
	...
	public void createOrder(Map<?, ?> orderWc) {
		//order.((orderSf.get("order_number").toString()));
		...
		order.setC_DocTypeTarget_ID((int)wcDefaults.get_Value("C_DocType_ID"));
		//order.setPaymentRule(MOrder.PAYMENTRULE_CreditCard);
		order.setC_OrderSource_ID((int)wcDefaults.get_Value("C_OrderSource_ID"));
