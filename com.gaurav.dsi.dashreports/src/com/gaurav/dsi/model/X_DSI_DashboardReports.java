...
/** Generated Model for DSI_DashboardReports
 *  @author iDempiere (generated) 
 *  @version Release 7.1 - $Id$ */
public class X_DSI_DashboardReports extends PO implements I_DSI_DashboardReports, I_Persistent 
{
    ...
    public X_DSI_DashboardReports (Properties ctx, int DSI_DashboardReports_ID, String trxName)
    {
      super (ctx, DSI_DashboardReports_ID, trxName);
      /** if (DSI_DashboardReports_ID == 0)
        {
			setAD_Table_ID (0);
			setDSI_DashboardReports_ID (0);
			setEntityType (null);
// @SQL=select get_sysconfig('DEFAULT_ENTITYTYPE','U',0,0) from dual
    ...
    /** Load Constructor */
    public X_DSI_DashboardReports (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DSI_DashboardReports[")
	...
	/** Set Dashboard Reports.
		@param DSI_DashboardReports_ID Dashboard Reports	  */
	public void setDSI_DashboardReports_ID (int DSI_DashboardReports_ID)
	{
		if (DSI_DashboardReports_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DSI_DashboardReports_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DSI_DashboardReports_ID, Integer.valueOf(DSI_DashboardReports_ID));
	}

	/** Get Dashboard Reports.
		@return Dashboard Reports	  */
	public int getDSI_DashboardReports_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DSI_DashboardReports_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set DSI_DashboardReports_UU.
		@param DSI_DashboardReports_UU DSI_DashboardReports_UU	  */
	public void setDSI_DashboardReports_UU (String DSI_DashboardReports_UU)
	{
		set_Value (COLUMNNAME_DSI_DashboardReports_UU, DSI_DashboardReports_UU);
	}

	/** Get DSI_DashboardReports_UU.
		@return DSI_DashboardReports_UU	  */
	public String getDSI_DashboardReports_UU () 
	{
		return (String)get_Value(COLUMNNAME_DSI_DashboardReports_UU);
	}
