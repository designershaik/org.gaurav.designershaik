...
public class WDocumentStatusIndicator extends Panel implements EventListener<Event> {
	 ...
	 */
	public WDocumentStatusIndicator(MDSIDashboardReports m_indicators)
	{
		super();

		m_documentStatus = m_indicators;
	...
	private MDSIDashboardReports		m_documentStatus = null;
	 ...
	 */
	public MDSIDashboardReports getDocumentStatus()
	{
	...
	private void init()
	{
		...
		nameLabel.setText(m_documentStatus.get_Translation(MDSIDashboardReports.COLUMNNAME_Name) + ": ");
	...
	public void onEvent(Event event) throws Exception
	{
		...
		if (AD_Window_ID > 0)
		{
			...
			query.addRestriction(MDSIDashboardReports.getWhereClause(m_documentStatus));
	...
	public void refresh() {
		statusCount = MDSIDashboardReports.evaluate(m_documentStatus);		
	}
