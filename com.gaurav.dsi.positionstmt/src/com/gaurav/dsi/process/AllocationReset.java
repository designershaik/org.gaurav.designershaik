...
public class AllocationReset extends SvrProcess
{
	...
	private Timestamp p_dateCreate_from = null;
	private Timestamp p_dateCreate_To = null;
	/**
	...
	protected void prepare()
	{
		...
		for (int i = 0; i < para.length; i++)
		{
			...
			{
				p_dateCreate_from = (Timestamp)para[i].getParameter();
				p_dateCreate_To = (Timestamp)para[i].getParameter_To();
			}
