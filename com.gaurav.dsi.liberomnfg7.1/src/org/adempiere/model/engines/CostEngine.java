...
public class CostEngine
{
	...
	public void createCostDetail (IDocumentLine model , MTransaction mtrx)
	{
		...
		for(MAcctSchema as : getAcctSchema(mtrx))
		{
			 ...
			 *  20 June 2016 
			 *  Allow component to have different costing method than standard costing which is hard coded here.
			 *  Created system configurator for the setting.
			 */
			boolean useOtherCostingMethodForMO=MSysConfig.getBooleanValue("USE_OTHER_COSTING_FOR_COMPONENT_INMO", true);
			if(!useOtherCostingMethodForMO)
			{
