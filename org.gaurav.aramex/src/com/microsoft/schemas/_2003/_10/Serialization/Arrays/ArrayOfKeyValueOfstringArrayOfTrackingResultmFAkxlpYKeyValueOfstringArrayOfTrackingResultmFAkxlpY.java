...
public class ArrayOfKeyValueOfstringArrayOfTrackingResultmFAkxlpYKeyValueOfstringArrayOfTrackingResultmFAkxlpY  implements java.io.Serializable {
    ...
    private net.aramex.ws.ShippingAPI.v1.TrackingResult[] value;
    ...
    public ArrayOfKeyValueOfstringArrayOfTrackingResultmFAkxlpYKeyValueOfstringArrayOfTrackingResultmFAkxlpY(
           ...
           net.aramex.ws.ShippingAPI.v1.TrackingResult[] value) {
           this.key = key;
           this.value = value;
    }
     ...
     * @return value
     */
    public net.aramex.ws.ShippingAPI.v1.TrackingResult[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(net.aramex.ws.ShippingAPI.v1.TrackingResult[] value) {
        this.value = value;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", "TrackingResult"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", "TrackingResult"));
        typeDesc.addFieldDesc(elemField);
    }
