...
public class BasicHttpBinding_Service_1_01Stub extends org.apache.axis.client.Stub implements net.aramex.ws.ShippingAPI.v1.Service_1_0 {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", "ShipmentTrackingRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", ">ShipmentTrackingRequest"), net.aramex.ws.ShippingAPI.v1.ShipmentTrackingRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", ">ShipmentTrackingResponse"));
        oper.setReturnClass(net.aramex.ws.ShippingAPI.v1.ShipmentTrackingResponse.class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", "PickupTrackingRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", ">PickupTrackingRequest"), net.aramex.ws.ShippingAPI.v1.PickupTrackingRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://ws.aramex.net/ShippingAPI/v1/", ">PickupTrackingResponse"));
        oper.setReturnClass(net.aramex.ws.ShippingAPI.v1.PickupTrackingResponse.class);
    ...
    public BasicHttpBinding_Service_1_01Stub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = net.aramex.ws.ShippingAPI.v1.PickupTrackingRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.aramex.ws.ShippingAPI.v1.PickupTrackingResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.aramex.ws.ShippingAPI.v1.ShipmentTrackingRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.aramex.ws.ShippingAPI.v1.ShipmentTrackingResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.aramex.ws.ShippingAPI.v1.TrackingResult[].class;
            cachedSerClasses.add(cls);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {parameters});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (net.aramex.ws.ShippingAPI.v1.ShipmentTrackingResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.aramex.ws.ShippingAPI.v1.ShipmentTrackingResponse) org.apache.axis.utils.JavaUtils.convert(_resp, net.aramex.ws.ShippingAPI.v1.ShipmentTrackingResponse.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {parameters});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (net.aramex.ws.ShippingAPI.v1.PickupTrackingResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.aramex.ws.ShippingAPI.v1.PickupTrackingResponse) org.apache.axis.utils.JavaUtils.convert(_resp, net.aramex.ws.ShippingAPI.v1.PickupTrackingResponse.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
