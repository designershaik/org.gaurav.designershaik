...
public class Service_1_0Locator extends org.apache.axis.client.Service implements Service_1_0 {

    public Service_1_0Locator() {
    }


    public Service_1_0Locator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Service_1_0Locator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for BasicHttpBinding_Service_1_0
    private java.lang.String BasicHttpBinding_Service_1_0_address = "http://ws.aramex.net/ShippingAPI.V2/Tracking/Service_1_0.svc";
    ...
    public net.aramex.ws.ShippingAPI.v1.Service_1_0 getBasicHttpBinding_Service_1_0() throws javax.xml.rpc.ServiceException {
    ...
    public net.aramex.ws.ShippingAPI.v1.Service_1_0 getBasicHttpBinding_Service_1_0(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            BasicHttpBinding_Service_1_0Stub _stub = new BasicHttpBinding_Service_1_0Stub(portAddress, this);
    ...
    private java.lang.String BasicHttpBinding_Service_1_01_address = "https://anfe02.aramex.com/ShippingAPI.V2/Tracking/Service_1_0.svc";
    ...
    public net.aramex.ws.ShippingAPI.v1.Service_1_0 getBasicHttpBinding_Service_1_01() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public net.aramex.ws.ShippingAPI.v1.Service_1_0 getBasicHttpBinding_Service_1_01(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            BasicHttpBinding_Service_1_01Stub _stub = new BasicHttpBinding_Service_1_01Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.aramex.ws.ShippingAPI.v1.Service_1_0.class.isAssignableFrom(serviceEndpointInterface)) {
                BasicHttpBinding_Service_1_0Stub _stub = new BasicHttpBinding_Service_1_0Stub(new java.net.URL(BasicHttpBinding_Service_1_0_address), this);
                _stub.setPortName(getBasicHttpBinding_Service_1_0WSDDServiceName());
                return _stub;
            }
            if (net.aramex.ws.ShippingAPI.v1.Service_1_0.class.isAssignableFrom(serviceEndpointInterface)) {
                BasicHttpBinding_Service_1_01Stub _stub = new BasicHttpBinding_Service_1_01Stub(new java.net.URL(BasicHttpBinding_Service_1_01_address), this);
                _stub.setPortName(getBasicHttpBinding_Service_1_01WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        else if ("BasicHttpBinding_Service_1_01".equals(inputPortName)) {
...
{ // Unknown Port Name
    ...
    */
	...
	@Override
	public ShipmentTrackingResponse trackShipments(
			ShipmentTrackingRequest parameters) throws RemoteException {
	...
	@Override
	public PickupTrackingResponse trackPickup(PickupTrackingRequest parameters)
