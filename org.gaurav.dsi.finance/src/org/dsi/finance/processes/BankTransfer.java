...
public class BankTransfer extends SvrProcess
{
	...
	private BigDecimal p_Rate = Env.ZERO;
	/**
	...
	private void generateBankTransfer()
	{
		...
		paymentBankFrom.setC_DocType_ID(C_DocTypePayment_ID);
		paymentBankFrom.setC_Charge_ID(p_C_Charge_ID);
		paymentBankFrom.set_ValueNoCheck("Rate", p_Rate);
...
//		}
		...
		paymentBankTo.setC_DocType_ID(C_DocTypeReceipt_ID);
