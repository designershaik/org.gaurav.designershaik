 ...
 */
public class DSCustomDunningRunCreate extends SvrProcess
{
	...
	{
		int AD_Window_ID = Env.getContextAsInt(Env.getCtx(), "1|_WinInfo_AD_Window_ID");
		int AD_Tab_ID = Env.getContextAsInt(Env.getCtx(), "1|0|_TabInfo_AD_Tab_ID");
		System.out.println(AD_Window_ID+" Tab "+AD_Tab_ID);
