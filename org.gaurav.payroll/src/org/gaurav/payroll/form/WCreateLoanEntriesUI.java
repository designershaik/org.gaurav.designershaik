...
public class WCreateLoanEntriesUI extends WCreateLoanGLEntries implements EventListener<Event>{

	public WCreateLoanEntriesUI(GridTab mTab)
	{
		super(mTab);
	...
	public boolean dynInit() throws Exception
	{
		...
		if (getGridTab().getValue("GL_Journal_ID") == null)
		{
		...
		Timestamp date = Env.getContextAsDate(Env.getCtx(), p_WindowNo, MJournal.COLUMNNAME_DateAcct);
	...
	{
		loadTableOIS(getBankAccountData(bPartnerLookup.getValue(), dateFromField.getValue(), dateToField.getValue(),
