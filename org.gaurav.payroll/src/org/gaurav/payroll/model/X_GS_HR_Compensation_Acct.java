...
public class X_GS_HR_Compensation_Acct extends PO implements I_GS_HR_Compensation_Acct, I_Persistent 
{
    ...
    {
      super (ctx, GS_HR_Compensation_Acct_ID, trxName);
      /** if (GS_HR_Compensation_Acct_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_GS_HR_Compensation_Acct (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_GS_HR_Compensation_Acct[")
	...
	/** Set GS_HR_Compensation_Acct_UU.
		@param GS_HR_Compensation_Acct_UU GS_HR_Compensation_Acct_UU	  */
	public void setGS_HR_Compensation_Acct_UU (String GS_HR_Compensation_Acct_UU)
	{
		set_Value (COLUMNNAME_GS_HR_Compensation_Acct_UU, GS_HR_Compensation_Acct_UU);
	}

	/** Get GS_HR_Compensation_Acct_UU.
		@return GS_HR_Compensation_Acct_UU	  */
	public String getGS_HR_Compensation_Acct_UU () 
	{
